...
public class MqttIncomingPublishFlows {
    ...
    MqttIncomingPublishFlows(final @NotNull MqttSubscriptionFlows subscriptionFlows) {
        ...
        globalFlows = new HandleList[MqttGlobalPublishFlowType.values().length];
    }
    ...
    void subscribeGlobal(final @NotNull MqttGlobalIncomingPublishFlow flow) {
        ...
        HandleList<MqttGlobalIncomingPublishFlow> globalFlow = globalFlows[type];
        if (globalFlow == null) {
    ...
    void cancelGlobal(final @NotNull MqttGlobalIncomingPublishFlow flow) {
        ...
        handle.remove();
        final int type = flow.getType().ordinal();
        final HandleList<MqttGlobalIncomingPublishFlow> globalFlow = globalFlows[type];
