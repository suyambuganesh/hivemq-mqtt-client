...
public class MqttClientData implements Mqtt5ClientData {
    ...
    private final @Nullable MqttWebSocketConfig webSocketConfig;
    ...
    public MqttClientData(
            ...
            final @NotNull String serverHost, final int serverPort, final @Nullable MqttClientSslConfig sslConfig,
            final @Nullable MqttWebSocketConfig webSocketConfig, final boolean followsRedirects,
    ...
    public @Nullable MqttClientSslConfig getRawSslConfig() {
        return sslConfig;
    }
    ...
    public @Nullable MqttWebSocketConfig getRawWebSocketConfig() {
